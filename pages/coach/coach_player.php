...
<html lang="ja">
  <head>
    ...
    <!-- player.cssの内容をcoach_pageにて新たにcssを組むか検討中 -->
    <title>BBSM|選手情報(監督室)</title>
  </head>
  <body>
    <div class="wrapper">
      <?php $linkPath = "../main/main.php"; $imgPath = "../../"; require("../common/header.php"); ?>
      <div class="player">
        <?php $title = "選手情報(監督室)"; require("../common/title.php");?>
        <article class="player_container">
          ...
          <section class="coachMemo">
            <p class="coachMemo_text">ここにメモが入る</p>
            <div class="coachMemo_action">
              <a href="../coach/coach_player_edit.php" class="coachMemo_edit">編集</a>
            </div>
          </section>
        </article>
      </div>
